...
import pandas as pd
import faltantes_inversos
import importa as imp
...
def regressao_tipo_1(acomph, a0, a1, postos, mes):
...
def regressao_tipo_3(mes):
    data_postos_tipo3 = {126: prev_tipo3.posto_126(), 127: prev_tipo3.posto_127(), 131: prev_tipo3.posto_131(), 132: prev_tipo3.posto_132(),
                         ...
                         299: prev_tipo3.posto_299(), 302: prev_tipo3.posto_302(), 303: prev_tipo3.posto_303(), 304: prev_tipo3.posto_304(),
...
def vazoes_finais(mes):
    acomph, a0, a1, postos = imp.arquivos #Recebe os postos, vazões e coeficientes de regressão tipo 1
    ...
    faltantes = faltantes_inversos.cria_tabela(mes) #Recebe as vazões de postos com regressões específicas ou interdependentes
